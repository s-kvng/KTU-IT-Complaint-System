        ...
        <View className="bg-white min-h-full rounded-t-3xl p-7 pt-10">
          ...
          <ScrollView className="flex-1 px-1 pt-2">
            <View className=" flex flex-row gap-5 flex-wrap">
              <View className=" bg-teal-300 h-28 w-40 justify-center items-center shadow-lg rounded-md">
                <TextUi className=" text-xl">Complaints</TextUi>
                <TextUi className="font-semibold text-lg">12</TextUi>
              </View>

              <View className=" bg-sky-200 h-28 w-40 justify-center items-center shadow-lg rounded-md">
                <TextUi className=" text-xl">Assigned Complaints</TextUi>
                <TextUi className="font-semibold text-lg">12</TextUi>
              </View>

              <View className=" bg-indigo-300 h-28 w-40 justify-center items-center shadow-lg rounded-md">
